...
def inference(images):
    ...
    norm2 = tf.nn.lrn(conv2, bias=1.0, alpha=0.001 / 9.0, beta=0.75, name='norm2')
...
def loss(logits, labels):
    ...
    return tf.add_to_collection('losses', name='total_loss')
...
def _add_loss_summaries(total_loss):
    ...
    for i in losses + [total_loss]:
        ...
        tf.summary.scalar(i.op.name, loss_average.average(i))
