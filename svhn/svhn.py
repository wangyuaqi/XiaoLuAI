...
tf.app.flags.DEFINE_string('data_dir', '/home/lucasx/Documents/Dataset/ImageDataSet/SVHN/',
...
def distorted_inputs():
    ...
    images, labels = svhn_input.distorted_inputs(data_dir=FLAGS.data_dir,
...
def inputs(eval_data):
    ...
    images, labels = svhn_input.inputs(eval_data=eval_data,
                                       data_dir=data_dir,
                                       batch_size=FLAGS.batch_size)
    if FLAGS.use_fp16:
        images = tf.cast(images, tf.float16)
