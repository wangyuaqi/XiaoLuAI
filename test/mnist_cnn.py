...
W_con2 = weight_variable([5, 5, 1, 64])
b_conv2 = bias_variable([64])

h_conv2 = tf.nn.relu(conv2d(x_image, W_con2) + b_conv2)
...
training_step = tf.train.GradientDescentOptimizer(1e-4).minimize(cross_entropy)
